...
<html>
    ...
    <head>
        <title>Exportar gr&aacute;fico - Eurossad</title>
            ...
            <div class="form"  style="width: 600px;">
                <div class="formTitle" >
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td width="400"><span class="formLabel" style="font-size: 14px; font-family: Arial; color: #6E6E6E;">Exportar gr&aacute;fico: <?=$diagram->title?></span></td>
                            <td colspan="2">&nbsp;</td>
                        </tr>
                    </table>
                </div>
                ...
                <a href="./editor.php?diagramId=<?=$diagram->id?>">regresar a editar gr&aacute;fico</a>
            </div>
        </div>
