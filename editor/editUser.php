            ...
            <div class="form"  style="width: 600px;">
                <div class="formTitle" >
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td width="400"><span class="formLabel" style="font-size: 14px; font-family: Arial; color: #6E6E6E;">Editar usuario</span></td>
                            <td colspan="2">&nbsp;</td>
                        </tr>
                    </table>
                </div>
                ...
                <form action="./common/controller.php" method="POST">
                    ...
                    <table>
                        ...
                        <tr>
                            <td><label for="email">Password <br/>(dejar en blanco para conservar el actual)</label></td>
                            <td><input type="text" name="password" id="password" /></td>
                        </tr>
                        <tr>
                            <td><a href="./users.php">Cancelar</a></td>
