...
<html>
    ...
    <head>
        ...
        <script type="text/javascript" src="./lib/sets/nivel1/nivel1.js"></script>
        <script type="text/javascript" src="./lib/sets/nivel2/nivel2.js"></script>
        <script type="text/javascript" src="./lib/sets/nivel3/nivel3.js"></script>
        <script type="text/javascript" src="./lib/sets/nivel4/nivel4.js"></script>
    ...
    $(document).ready(function() {
        ...
        $.modal("<div>"+
            ...
            "<a style='text-decoration: none; color:black;' href='./myDiagrams.php' title='Abrir gr&aacute;fico'><img src='./assets/images/icon_open.jpg' border='0' width='16' height='16'/>&nbsp;Abrir gr&aacute;fico</a><br />"+
            "<a style='text-decoration: none; color:black;' href='' title='Nuevo gr&aacute;fico Nivel 1'><img src='./assets/images/icon_new.jpg' border='0' width='16' height='16'/>&nbsp;Nuevo gr&aacute;fico Nivel 1</a><br />"+
            "<a style='text-decoration: none; color:black;' href='' title='Nuevo gr&aacute;fico Nivel 2'><img src='./assets/images/icon_new.jpg' border='0' width='16' height='16'/>&nbsp;Nuevo gr&aacute;fico Nivel 2</a><br />"+
            "<a style='text-decoration: none; color:black;' href='' title='Nuevo gr&aacute;fico Nivel 3'><img src='./assets/images/icon_new.jpg' border='0' width='16' height='16'/>&nbsp;Nuevo gr&aacute;fico Nivel 3</a><br />"+
            "<a style='text-decoration: none; color:black;' href='' title='Nuevo gr&aacute;fico Nivel 4'><img src='./assets/images/icon_new.jpg' border='0' width='16' height='16'/>&nbsp;Nuevo gr&aacute;fico Nivel 4</a><br />"+
            "</div>");
        var appURL = '<?=$WEBADDRESS?>';
    });
        ...
        <div id="actions">
            ...
            <a style="text-decoration: none;" href="#" onclick="return save();" title="Guardar gr&aacute;afico (Ctrl-S)"><img src="assets/images/icon_save.jpg" border="0" width="16" height="16"/></a>
            
            <img class="separator" src="assets/images/toolbar_separator.gif" border="0" width="1" height="16"/>
            
            <a style="text-decoration: none;" href="./myDiagrams.php" title="Abrir gr&aacute;fico"><img src="assets/images/icon_open.jpg" border="0" width="16" height="16"/></a>

            <?if(isset($_REQUEST['diagramId']) &&  is_numeric($_REQUEST['diagramId']) ){//option available ony when the diagram was saved?>
                <img class="separator" src="assets/images/toolbar_separator.gif" border="0" width="1" height="16"/>
                <a style="text-decoration: none;" href="#" onclick="return print_diagram();" title="Imprimir gr&aacute;fico"><img src="assets/images/icon_print.png" border="0" width="16" height="16"/></a>
            <?}?>
            ...
            <a href="javascript:action('connector-jagged');" title="Conector articulado"><img src="assets/images/icon_connector_jagged.gif" border="0"/></a>
            
            <img class="separator" src="assets/images/toolbar_separator.gif" border="0" width="1" height="16"/>
            
            <a href="javascript:action('connector-organic');" title="Conector org&aacute;nico"><img src="assets/images/icon_connector_organic.gif" border="0" alt="Organico"/></a>
            
            <img class="separator" src="assets/images/toolbar_separator.gif" border="0" width="1" height="16"/>
            
            <a href="javascript:action('container');" title="Contenedor"><img src="assets/images/container.png" border="0" alt="Contenedor"/></a>
            
            <img class="separator" src="assets/images/toolbar_separator.gif" border="0" width="1" height="16"/>            
                        
            <input type="checkbox" onclick="showGrid();" id="gridCheckbox"  title="cuadr" /> <span class="toolbarText">Cuadr&iacute;cula</span>
            
            <img class="separator" src="assets/images/toolbar_separator.gif" border="0" width="1" height="16"/>
            
            <input type="checkbox" onclick="snapToGrid();" id="snapCheckbox" title="ajustar a cuadr" /> <span class="toolbarText">Ajustar a cuadr&iacute;cula</span>
            ...
            <a href="javascript:action('moveforward');" title="Mover (un nivel) al frente"><img src="assets/images/icon_forward.gif" border="0"/></a>
            
            <img class="separator" src="assets/images/toolbar_separator.gif" border="0" width="1" height="16"/>
            
            <a href="javascript:action('moveback');" title="Mover (un nivel) al fondo"><img src="assets/images/icon_backward.gif" border="0"/></a>
            ...
            <a href="javascript:createFigure(figure_Text, 'assets/images/text.gif');"  title="Texto"><img  src="assets/images/text.gif" border="0" height ="16"/></a>
            <img class="separator" src="assets/images/toolbar_separator.gif" border="0" width="1" height="16"/>
            
            <a href="javascript:showInsertImageDialog();"  title="Imagen"><img src="assets/images/image.gif" border="0" height ="16" alt="Imagen"/></a>
            <img class="separator" src="assets/images/toolbar_separator.gif" border="0" width="1" height="16"/>
...
//                    }
            ...
            <div style="width: 100%">
                <div  id="container">
                    <canvas id="a" width="850" height="1000">
                        Tu navegador no soporta HTML5. Por favor actualizalo o cambia a uno mas moderno.
                    </canvas>
                    <div id="text-editor"></div>
                    <div id="text-editor-tools"></div>

                    <div id="usuario" style="display: none;"><? echo htmlspecialchars($loggedUser->name); ?></div>
                    <!-- <img src="./assets/images/recuadro.png" id="background" /> -->
        ...
        <div id="import-dialog" style="background-color: white; display: none; margin-top: auto; margin-bottom: auto;">
            <form action="./common/controller.php" method="POST" enctype="multipart/form-data">
                ...
                <h2>Importar archivo Eurossad </h2>
                <p/>
