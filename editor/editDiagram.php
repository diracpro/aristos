...
if (!isset($_REQUEST['diagramId'])) {
    echo "Ningun gr&aacute;fico seleccionado";
    exit();
}
...
<html>
    <head>
        <title>Eurossad - Editar gr&aacute;fico</title>
                ...
                <div class="form" style="width: 400px;">
                    ...
                    <form  style="position: relative; height: 270px;" action="./common/controller.php" method="post">
                        ...
                        <div style="position: absolute; top: 50px; left: 20px;">
                             <span class="formLabel">Descripci&oacute;n(opcional)</span>
                        </div>
                        ...
                        <div style="position: absolute; top: 160px; left: 20px;">
                            <input type="checkbox" name="public" value="true" <?=$diagram->public ? 'checked' : '' ?>/><span class="formLabel">P&uacute;blico</span>
                        </div>
