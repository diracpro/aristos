            ...
            <?} else {?>
                ...
                <div class="form"  style="width: 600px;">
                    <div class="formTitle" >
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td width="400"><span class="formLabel" style="font-size: 14px; font-family: Arial; color: #6E6E6E;">Usuarios</span></td>
                                <td colspan="2">&nbsp;</td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <table border="0" width="100%">
                        <tr>
                            ...
                            <td align="center"><span class="formLabel">Remover usuario</span></td>
                        </tr>
                ...
                <div class="form"  style="width: 600px;">
                    <div class="formTitle" >
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td width="400"><span class="formLabel" style="font-size: 14px; font-family: Arial; color: #6E6E6E;">Compartir gr&aacute;fico con otros usuarios</span></td>
                                <td colspan="2">&nbsp;</td>
                            </tr>
                        </table>
                    </div>
