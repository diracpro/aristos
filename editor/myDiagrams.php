...
<html>
    ...
    <head>
        <title>Mis gr&aacute;ficos - Eurossad</title>
    ...
    <body>
            ...
            <div style="width: 600px; margin-left: auto; margin-right: auto;">
                <div class="formTitle" >
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td width="200"><span class="formLabel" style="font-size: 14px; font-family: Arial; color: #6E6E6E;">Mis gr&aacute;ficos</span></td>
                            <td>&nbsp;</td>
                ...
                <table style="position:relative; /*background-color:#F6F6F6;*/ top: 0px; width: 596px; border: 1px solid gray;"  border="0" align="center" cellpadding="5" cellspacing="0" width="100%">
                    ...
                    <tr style="background-color:#EBEBEB;" >
                        ...
                        <td align="left" ><span class="formLabel">Vista</span></td>
                        <td align="left" ><span class="formLabel">Exportar / Download</span></td>
                        <td align="left" ><span class="formLabel">Last Edit</span></td>                        
                        <td><span class="formLabel">P&uacute;blico</span></td>
                        <td><span class="formLabel">Settings</span></td>
                        <td><span class="formLabel">Borrar</span></td>
                    </tr>     
        ...
        <p></p>
        <div class="copyright">&copy; <?=date('Y')?> Eurosoft</div>
