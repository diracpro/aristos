...
figureSets["nivel2"] = {
    name: 'Nivel 2',
    description : 'Elementos del segundo nivel',
    figures: [
        {figureFunction: "Proceso2", image: "Proceso.png", title: "Proceso"},
        {figureFunction: "Entidad_externa2", image: "Entidad_externa.png", title: "Entidad externa"},
        {figureFunction: "Procedimiento", image: "Procedimiento.png", title: "Procedimiento"},
        {figureFunction: "Paquete", image: "Paquete.png"},
        /*,
...
function figure_Entidad_externa2(x, y)
{
...
function figure_Procedimiento(x, y)
{
    var f = new Figure("Procedimiento");
    f.style.fillStyle = FigureDefaults.fillStyle;
    f.style.strokeStyle = FigureDefaults.strokeStyle;
...
//    r.style.lineJoin = r.style.STYLE_LINE_JOIN_MITER;
    var desplazar = 4;
    rr.addPoint(new Point(x +desplazar, y +desplazar));
    rr.addPoint(new Point(x + FigureDefaults.segmentSize -desplazar, y +desplazar));
    rr.addPoint(new Point(x + FigureDefaults.segmentSize -desplazar, y + rectangleHeight -desplazar));
    rr.addPoint(new Point(x +desplazar, y + rectangleHeight -desplazar));

    f.addPrimitive(rr);

    var t2 = new Text("Procedimiento", x + FigureDefaults.segmentSize/2, y + rectangleHeight/2, FigureDefaults.textFont, FigureDefaults.textSize);
    t2.style.fillStyle = FigureDefaults.textColor;
...
function figure_Paquete(x,y)
{

    var f = new Figure("Paquete");
    f.style.fillStyle = FigureDefaults.fillStyle;
    f.style.strokeStyle = FigureDefaults.strokeStyle;
    f.style.lineWidth = 2;
...
//    f.properties.push(new BuilderProperty(BuilderProperty.SEPARATOR));
    ...
    var t2 = new Text("Paquete", x + FigureDefaults.segmentSize/2, y + FigureDefaults.segmentShortSize/2 + FigureDefaults.corner, FigureDefaults.textFont, FigureDefaults.textSize);
    t2.style.fillStyle = FigureDefaults.textColor;
